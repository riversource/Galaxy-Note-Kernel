...
#define RP_ARM_INTR_CODE_MASK		(0x3FFF)
/* ARM to RP */
...
/* ARM to RP */
#define RP_ARM_INTR_CODE_FORCE_MONO	(0x0001 << 11)
#define RP_ARM_INTR_CODE_AM_FILTER_LOAD	(0x0001 << 12)
#define RP_ARM_INTR_CODE_SB_TABLET	(0x0001 << 13)
