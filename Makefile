...
ABYSS_FLAGS	= -floop-intercharge -floop-strip-mine -floop-block \
-fno-tree-vectorize -mtune=cortex-a9 -march=armv7-a -pipe		
MODFLAGS	= -DMODULE
...
# This warning generated too much noise in a regular built
